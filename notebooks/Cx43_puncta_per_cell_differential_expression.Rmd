...
puncta <- read.csv("~/Cam_Dropbox/Nat_Hastings/PD_data/Cx43_puncta_per_cell_BoxCox_transformed.csv", row.names=1)
...
batches <- read.csv("~/Cam_Dropbox/Nat_Hastings/PD_data/Cx43_puncta_batches.csv", row.names=1, stringsAsFactors = TRUE)
